...
class _Channels(EnvConfig, env_prefix="channels_"):
    ...
    dev_alerts: int = 1087922776024830075
    mod_alerts: int = 1087908228978966669
    soc_alerts: int = 1087922465021370388

    dev_log: int = 1012202489342345246
    mod_log: int = 1087901347040465006
    soc_log: int = 1087901419132170260

    soc_category: int = 1086886764255395900
